...
* OBS4: Lo que diferencia entre filas y columnas es si tiene salto de linea o n-
* o. Filas = Salto de linea. Columnas = No tiene salto de linea
**/
  ...
  public static void main(String[] args){    
    ...
    do {                                                      //El Do While imprime las 15 filas
      ...
      for(int apuesta = 1; apuesta <= columnas ; apuesta++){  // En el FOR las apuestas se repiten tantas veces como columnas haya.
        numeroGenerado = (int)(Math.random() * 6) + 1;        // Y dependiendo de qué numero aleatorio haya sido generado 
